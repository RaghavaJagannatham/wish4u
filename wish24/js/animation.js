...
const config = {
    name: "Nikhila", // actual name of the recipient (Mandatory)

    nickname: "😘 Sadisht 👻", // nickname(optional)

    pic: "C:\Users\lenovo\OneDrive\Desktop\Raghava\Nik\Wishes\Images\nik7", //image url of recipients (Mandatory)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "      Thankyou for your Behaviour,    for your in-consistency😑, for replacing me all with your Friends and buddies😏... STUPID🙄 THAT`S MY PLACE😬!!! you never understands howmuch Mean you are to meee 😒, I know you forget or ignore all this😕. Still Many Many more Happy 💖 returns of the day💞...🥳🥳🥳";
